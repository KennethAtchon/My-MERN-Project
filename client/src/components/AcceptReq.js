...
import Requesttable from '../tools/reqtable';

import { connect, useDispatch } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { getProtectedRoute } from '../auth/index';
import { getRequests } from '../actions/requests/GetReqAction';
...
function DashboardContent(props) {
  ...
  useEffect(() =>{
    ...
    dispatch(getRequests(mainuser.email)).then(() => {

      console.log("Got the requests");
    })
    .catch(error => {
      console.log(error);
    });
